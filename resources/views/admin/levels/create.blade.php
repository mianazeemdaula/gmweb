...
@section('content')
    <div class="bg-white rounded-lg">
        ...
        @endforeach --}}
        <form action="{{ route('admin.levels.store') }}" method="post" class="" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 p-2 gap-2 md:p-4 items-end">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" placeholder="Reward Price" name="return_percentage" value="{{ old('return_percentage') }}" class="border p-1 rounded-sm  w-80 ">
